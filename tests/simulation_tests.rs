...
mod tests {
    ...
    fn test_simulate_porec() {
        ...
        let bed = String::from(
            "/data3/wangyb/DATA/AT/Simulates_tetraploid/data/dorado_hac_9.4.q10.DpnII.bed",
        );
        let output =
            String::from("/data3/wangyb/DATA/AT/Simulates_tetraploid/data/Cvi-0.porec.fasta");
