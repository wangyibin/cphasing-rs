...
mod tests {
    ...
    #[test]
    fn test_paf2depth() {
        let paf = PAFTable::new(&String::from(
            "/data3/wangyb/0.CPhasing/alfalfa/1.default_porec/M1-2.paf.gz",
        ));
        let winsize = 5000;
        let stepsize = 1000;
        let chromsize = String::from(
            "/data3/wangyb/0.CPhasing/alfalfa/1.default_porec/M1_hifi.p_utg.contigsizes",
        );
